...
public class CassandraUserQueries {
    public static final String CREATE_USER = "INSERT INTO chat.users_by_uuid (user_uuid, created_at, email, is_deleted, password, nickname, picture_id) VALUES (uuid(), system.toTimestamp(system.now()), ?, false, ?, ?, ?)";
