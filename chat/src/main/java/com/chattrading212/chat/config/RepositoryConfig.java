...
import com.chattrading212.chat.repositories.cassandra.*;
...
public class RepositoryConfig {
    ...
    @Bean
    CassandraGroupRepository cassandraGroupRepository(CqlSession session) {
        return new CassandraGroupRepository(session);
    }
}
